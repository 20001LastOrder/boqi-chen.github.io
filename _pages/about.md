...
>
> During my PhD, I was a part-time research associate at _Huawei Waterloo Research Center_ through Quantum. Besides I'm also an active contributor to the open-source project [Sherpa](https://github.com/Aggregate-Intellect/sherpa) that aims to build a robust and easy-to-use large language model framework.
